...
const run = async () => {
  try {
    console.log('🚀 Building new Byline configuration...')
    ...
    console.error('Error during Byline build:', error)
  }
}
...
console.log(`👁️ Watching for Byline configuration changes in ${srcDir}...`)
